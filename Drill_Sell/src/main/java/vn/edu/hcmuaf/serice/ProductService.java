...
public class ProductService {
    ...
    public static List<Products> getAccessoryInHome() {
        return DbController.me().get().withHandle(handle -> {
            return handle.createQuery("\n" +
                            ...
                            "WHERE product_categorys.id IN (6, 7, 8) ORDER BY RAND() LIMIT 12;")
                    .mapToBean(Products.class)
                    .collect(Collectors
                            .toList());
        });
...
//            System.out.println(ProductService.getProductsByCategory(2));
        System.out.println(ProductService.getAccessoryInHome());
    }
}
