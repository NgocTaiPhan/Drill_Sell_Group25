...
<head>
    ...
    <title>Máy khoan động lực</title>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <div class="image"><a href="#"><img
                                                        src="assets/images/caterogy/movers/may-khoan-dong-luc-makita-m8101b-300.jpg"
    ...
    <div class="container" style="white-space: nowrap">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li class='active'>Máy Khoan Động Lực</li>
            </ul>
        ...
        <div class="row">
                                            ...
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"><a href="#"> <img
                                                                src="assets/images/caterogy/movers/may-khoan-dong-luc-bosch-gsb-550-a.jpg"
                                                                alt="Ảnh sản phẩm"> </a>
                                                        </div>
                                                        <!-- /.image -->
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="#">Máy khoan động lực và máy vặn vít 12V Makita</a></h3>
                                        ...
                                        <div class="product-micro">
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"><a href="#"> <img
                                                                src="assets/images/caterogy/movers/may-khoan-pin-dong-luc-dewalt-dcd996n-kr-400.jpg"
                                                                alt="Ảnh sản phẩm"> </a>
                                                        </div>
                                                        <!-- /.image -->
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="#">Máy khoan pin động lực Tolsen 79036 12V</a></h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"><span
                                    ...
                                    <div class="product">
                                        <div class="product-micro">
                                            <div class="row product-micro-row">
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="#">Máy khoan động lực pin Bosch GSB 120-LI 12V</a></h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"><span
            ...
            <div class='col-md-9'>
                ...
                <div id="category" class="category-carousel hidden-xs">
                    <div class="item">
                        <div class="image"><img src="assets/images/caterogy/poster_moves.png" alt="Ảnh sản phẩm"
                ...
                <section class="section wow fadeInUp accessory">
                    <h3 class="section-title">Phụ kiện máy khoan động lực</h3>
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"><a href="#"><img style="width: 189px; height: 189px"
                                                                            src="assets/images/caterogy/movers/11may-khoan-bua-26-cai-phu-kien-makita-m8103kx2b.jpg"
                                                                            alt="Ảnh sản phẩm"></a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="#">1 Bộ máy koan 26 phụ kiên</a></h3>
                                        <div class="rating rateit-small"></div>
                                        <div class="description"></div>
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"><a href="#"><img style="width: 189px; height: 189px"
                                                                            src="assets/images/caterogy/movers/bo-may-khoan-bosch-gsb-550-freedom-500.jpg"
                                                                            alt="Ảnh sản phẩm"></a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="#">Bộ khoan 21v 4ah amax ap404040</a></h3>
                                        <div class="rating rateit-small"></div>
                                        <div class="description"></div>
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="#">Bộ máy khoan bosch DC10SB</a></h3>
                                        <div class="rating rateit-small"></div>
                                        <div class="description"></div>
                                            ...
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"><a href="detail.html"><img
                                                            src="assets/images/caterogy/movers/may-khoan-van-vit-dong-luc-dewalt-dcd796m2-500.jpg"
                                                            alt="Ảnh sản phẩm"></a></div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan pin động lực dewalt kr400</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"><a href="detail.html"><img
                                                            src="assets/images/caterogy/movers/may-khoan-dong-luc-stanley-stdh7213-13mm-800w-500.jpg"
                                                            alt="Ảnh sản phẩm"></a></div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan động lực stanley CD027</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"><a href="detail.html"><img
                                                            src="assets/images/caterogy/battery/may-khoan-van-vit-dong-luc-dung-pin-bosch-gsb-120-li-500.jpg"
                                                            alt="Ảnh sản phẩm"></a></div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan động lực dùng pin bosch gsb 120li500</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"><a href="detail.html"><img
                                                            src="assets/images/caterogy/battery/may-khoan-van-vit-dong-luc-dung-pin-stanley-sch20c2k-500.jpg"
                                                            alt="Ảnh sản phẩm"></a></div>
                                                    <!-- /.image -->
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"><a href="detail.html"><img
                                                            src="assets/images/caterogy/battery/may-khoan-van-vit-dung-pin-bosch-gsb-180-li-300.jpg"
                                                            alt="Ảnh sản phẩm"></a></div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan động lực dùng pin posch gsb 180li</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"><a href="detail.html"><img
                                                            src="assets/images/caterogy/battery/may-khoan-van-vit-dung-pin-bosch-gsb-180-li-k2-promo-06019f83k2-300.jpg"
                                                            alt="Ảnh sản phẩm"></a></div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan vặn vít dùng pin bosch 180li promo</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">combo 2 máy khoan pin 16v baiter c16</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"><a href="detail.html"><img
                                                            src="assets/images/caterogy/battery/may-khoan-pin-20v-makute-cd029-300.jpg"
                                                            alt="Ảnh sản phẩm"></a></div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan pin 20v makute</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                        ...
                                        <div class="product-list product">
                                            <div class="row product-list-row">
                                                <div class="col col-sm-4 col-lg-4">
                                                    <div class="product-image">
                                                        <div class="image"><img
                                                                src="assets/images/caterogy/battery/may-khoan-pin-makute-cd027-300.jpg"
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="detail.html">Máy khoan động lực dùng pin makute cd027</a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"><span
                                    ...
                                    <div class="products">
                                        <div class="product-list product">
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="detail.html">Máy khoan động lực pin dewalt 60v</a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"><span
                                    ...
                                    <div class="products">
                                        <div class="product-list product">
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="detail.html">Máy khoan vặn vít makita cxl224s</a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"><span
