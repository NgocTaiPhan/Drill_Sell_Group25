        ...
        <div class="row">
            ...
            <div class='col-md-9'>
                ...
                <div id="category" class="category-carousel hidden-xs">
                    <div class="item">
                        <div class="image"><img src="assets/images/caterogy/poster_battery.jpg" alt="Ảnh sản phẩm"
                ...
                <section class="section wow fadeInUp accessory">
                    <h3 class="section-title">Phụ kiện máy khoan pin</h3>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan dùng pin KEN
                                                        b16212hb</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"><a href="detail.html"><img
                                                            src="assets/images/caterogy/battery/may-khoan-pin-dong-luc-dewalt-dcd996n-kr-400.jpg"
                                                            alt="Ảnh sản phẩm"></a></div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan pin động lực dewalt
                                                        kr400</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan pin Makute
                                                        CD027</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan động lực dùng pin
                                                        bosch gsb 120li500</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan vặn vít động lực
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan vặn vít dùng pin
                                                        bosch 180li promo</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">combo 2 máy khoan pin 16v
                                                        baiter c16</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                        ...
                                        <div class="product-list product">
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="detail.html">Máy khoan động lực dùng
                                                            pin makute cd027</a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"><span
                                    ...
                                    <div class="products">
                                        <div class="product-list product">
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="detail.html">Máy khoan động lực pin
                                                            dewalt 60v</a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"><span
                                    ...
                                    <div class="products">
                                        <div class="product-list product">
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="detail.html">Máy khoan vặn vít makita
                                                            cxl224s</a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"><span
                                    ...
                                    <div class="products">
                                        <div class="product-list product">
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="detail.html">Máy khoan pin ken
                                                            bl6212hb</a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"><span
                                    ...
                                    <div class="products">
                                        <div class="product-list product">
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="detail.html">Máy khoan vặn vít động
                                                            lực dùng pin bosch gsb
                                                            <div class="rating rateit-small"></div>
                                                            <div class="product-price"><span
                                                                    class="price"> 1.170.000đ  </span>
                                                                <span class="price-before-discount">1.390.000đ</span>
                                                            </div>
                                                            <!-- /.product-price -->
