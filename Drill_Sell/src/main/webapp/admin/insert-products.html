            ...
            <form action="/add-product" method="post" enctype="multipart/form-data">
                ...
                <div class="showImg    ">
                    <div class="center-block" style="margin: auto;">
                        ...
                        <img class="center-block" src="../assets/images/products/normal/may-khoan-dong-luc-bosch-gsb-13-re-hop.jpg" alt="Ảnh sản phẩm" style="width: 150px; height: 120px">
                    </div>
                    <input type="file" class="form-control" id="productImgae" name="productID" required>
