                    ...
                    >
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active  yamm-fw"><a href="feg.html">Sản phẩm</a></li>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                ...
                <div class="sidebar-widget product-tag wow fadeInUp">
                    ...
                    <div class="sidebar-widget-body outer-top-xs">
                        <div class="tag-list"><a class="item" title="Bosh" href="bosh.jsp">Bosh</a>
                            <a class="item " title="Makita" href="makita.jsp">Makita</a>
                            <a class="item" title="DeWalt" href="dewalt.jsp">DeWalt</a>
                            <a class="item" title="Tolsen" href="tolsen.jsp">Tolsen</a>
                            <a class="item" title="Classic" href="classic.jsp">Classic</a>
                            <a class="item" title="Sasuke" href="sasuke.jsp">Sasuke</a>
                            <a class="item" title="Sencan" href="sencan.jsp">Sencan</a>
                            <a class="item" title="feg" href="./feg.html">FEG</a>
                        </div>
                        <!-- /.tag-list -->
                    </div>
                    <!-- /.sidebar-widget-body -->
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="../detail.html">Máy khoan động lực Bosch GSB
                                                        16 RE - 06012281K1</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="../detail.html">Máy khoan bê tông 26mm FEG
                                                        EG-2601 SRE</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="../detail.html">Máy khoan bê tông Gomes
                                                        GB-2603</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="../detail.html">Máy khoan rút lõi Gomes
                                                        GCD-120</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="../detail.html">Máy khoan động lực Makita
                                                        M8101B</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="products">
                                        <div class="product-list product">
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="../detail.html">Máy khoan bê tông 26mm
                                                            FEG EG-2601 SRE</a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="product-price"><span
