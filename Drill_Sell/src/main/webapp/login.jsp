                ...
                <div class="col-md-6 col-sm-6 create-new-account">
                    ...
                    <form class="register-form outer-top-xs" role="form" id="register-form">
                        ...
                        >
                            ...
                            <label class="info-title" for="confirm-password-register">Chọn loại tài khoản
                                <span>*</span></label>
                            <div class="radio outer-xs" style="display: flex; justify-content: space-around">
                                <label>
                                    <input id="optionsRadios" name="optionsRadios" type="radio" value="">Quản trị
                                </label>
                                <label>
                                    <input id="optionsRadios3" name="optionsRadios" type="radio" value="">    Người dùng
                                </label>
                            </div>
                        </div>
                        <div class="form-group" style="white-space: nowrap;  ">
                            <input class=" form-checkbox-input" id="agree-to-terms" style="margin-right: 5px;"
                                   type="checkbox">
                            <label class="info-title" for="agree-to-terms">Đồng ý với <a href="rules.html">điều
