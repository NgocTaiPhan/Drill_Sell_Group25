        ...
        <div class="row">
            ...
            <div class='col-md-9'>
                ...
                <section class="section wow fadeInUp accessory">
                    <h3 class="section-title">Phụ kiện máy khoan cầm tay/h3>
                                ...
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"><a href="#"><img style="width: 189px; height: 189px"
                                                                            src="assets/images/caterogy/hand/11320x320-bo-mui-khoan-va-van-vit-xline-34mon-Bosch.jpg"
                                                                            alt="Ảnh sản phẩm"></a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="#">1 Bộ mũi khoan và vặn vít</a></h3>
                                        <div class="rating rateit-small"></div>
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"><a href="#"><img style="width: 189px; height: 189px"
                                                                            src="assets/images/caterogy/hand/11320x320-mui-khoan-da-nang-hex-9-bosch-2608579840-9x90x150-1-1664510717.jpg"
                                                                            alt="Ảnh sản phẩm"></a>
                                        </div>
                                        <!-- /.image -->
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="#">Mũi khoan đa năng</a></h3>
                                        <div class="rating rateit-small"></div>
                                        <div class="description"></div>
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    <div class="product-image">
                                        <div class="image"><a href="#"><img style="width: 189px; height: 189px"
                                                                            src="assets/images/caterogy/hand/11320x320-SDS_Plus_1.jpg"
                                                                            alt="Ảnh sản phẩm"></a>
                                        </div>
                                        <!-- /.image -->
                                            ...
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"><a href="detail.html"><img
                                                            src="assets/images/caterogy/hand/may-khoan-bosch-gbm-10-re-a.jpg"
                                                            alt="Ảnh sản phẩm"></a></div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan bosch gbm</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"><a href="detail.html"><img
                                                            src="assets/images/caterogy/hand/may-khoan-bosch-gbm-320.jpg"
                                                            alt="Ảnh sản phẩm"></a></div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoanbosch gmb 320</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                    ...
                                    <div class="col-sm-6 col-md-4 wow fadeInUp">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"><a href="detail.html"><img
                                                            src="assets/images/caterogy/hand/may-khoan-bosch-gbm-6-re-400.jpg"
                                                            alt="Ảnh sản phẩm"></a></div>
                                                    <!-- /.image -->
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="detail.html">Máy khoan bosch gbs 67re</a>
                                                    </h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
